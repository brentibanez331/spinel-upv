...
const CreateCandidateFormSchema = z.object({
  ...
  periodOfResidence: z.string().min(1, { message: "Period of residence is required" }),
  registeredVoterOf: z.string().min(1, { message: "Registered voter of is required" }),
  ...
  async function onSubmit(values: z.infer<typeof CreateCandidateFormSchema>) {
    ...
    if (values.image) {
      const { data: imageData, error: imageError } = await supabase.storage
        .from('images')
        .upload(
          `${crypto.randomUUID()}/${values.image.name}`,
          values.image
        );
    ...
    if (candidateError) {
      toast({
        variant: 'destructive',
        description: 'Error creating candidate record: ' + candidateError.message,
      });
      return;
    }
    ...
    if (personalInfoError) {
      toast({
        variant: 'destructive',
        description: 'Error creating personal info record: ' + personalInfoError.message,
      });
      return;
    }

    const { error: candidacyError } = await supabase
      .from('candidacy')
      .insert({
        id: crypto.randomUUID(),
        candidate_id: candidateData.id,
    ...
    if (candidacyError) {
      toast({
        variant: 'destructive',
        description: 'Error creating candidacy record: ' + candidacyError.message,
      });
      return;
    }
        ...
        <div className="grid-cols-4 grid">
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  ...
                  <FormControl>
                    <Input className="w-[300px]" placeholder="John" {...field} />
                  </FormControl>
                </FormItem>
              )}>
            </FormField>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  <FormLabel className="text-sm font-bold">Political Party</FormLabel>
                  <FormControl>
          ...
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  ...
                  <FormControl>
                    <Input className="w-[300px]" type="number" {...field} onChange={(e) => field.onChange(parseInt(e.target.value, 10) || 0)} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  <FormLabel className="text-sm font-bold">Birthplace</FormLabel>
                  <FormControl>
                    <Input className="w-[300px]" {...field} />
                  </FormControl>
                </FormItem>
          ...
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  <FormLabel className="text-sm font-bold">Civil Status</FormLabel>
                  <FormControl>
                    <Input className="w-[300px]" {...field} />
                  </FormControl>
                </FormItem>
          ...
          <div className="space-y-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  <FormLabel className="text-sm font-bold">Position Sought</FormLabel>
                  <FormControl>
                    <Input className="w-[300px]" {...field} />
                  </FormControl>
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  <FormLabel className="text-sm font-bold">Period of Residence</FormLabel>
                  <FormControl>
                    <Input className="w-[300px]" {...field} />
                  </FormControl>
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="space-y-1">
                  <FormLabel className="text-sm font-bold">Registered Voter of</FormLabel>
                  <FormControl>
                    <Input className="w-[300px]" {...field} />
                  </FormControl>
                </FormItem>
            ...
            <FormField
              ...
              render={({ field: { value, onChange, ...fieldProps } }) => (
                <FormItem>
                  <FormLabel className="text-sm font-bold">Profile Picture</FormLabel>
                  <FormControl>
                    <Input
                      className="w-[350px]"
                      type="file"
